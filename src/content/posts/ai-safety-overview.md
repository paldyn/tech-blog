...
[지난 글](/posts/llmops-fallback-strategies/)에서 LLM 서비스의 가용성을 높이는 Fallback 전략을 다뤘다. 이번 글은 한 발짝 물러서서 더 근본적인 질문을 다룬다. **이 AI가 제대로 작동하는지 어떻게 알 수 있는가? 올바르게 작동하지 않을 때 어떤 일이 벌어지는가?**
