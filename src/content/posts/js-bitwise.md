...
[지난 글](/posts/js-optional-chaining/)에서 `?.` 옵셔널 체이닝으로 null 안전 접근을 다뤘습니다. 이번에는 JavaScript의 저수준 비트 연산자를 다룹니다. 웹 프론트엔드에서는 자주 쓰이지 않지만, 권한 시스템, 이미지 처리, 프로토콜 파싱, 성능 최적화에서 비트 연산은 강력한 도구가 됩니다.
