...
2022년 DeepMind의 Hoffmann et al.이 발표한 Chinchilla 논문은 기존 상식을 뒤집었다. 더 꼼꼼한 실험 설계로 재분석한 결과, <strong>최적 비율은 `D ≈ 20 × N`</strong>임을 발견했다. Kaplan 법칙보다 데이터를 2배 더 써야 한다는 것이다.
