...
[지난 글](/posts/python-traceback-module/)에서 traceback 모듈로 예외 정보를 다루는 방법을 배웠다. 지금까지 배운 내용을 바탕으로 **무엇을 해야 하고 무엇을 피해야 하는지**를 정리한다. 코드 리뷰에서 자주 지적받는 안티패턴과 그에 대한 올바른 대안을 코드로 나란히 비교한다.
