...
<strong>"내 알고리즘은 최악의 경우에도 g(n)보다 느리지 않다"</strong>는 보장입니다.
...
<strong>"내 알고리즘은 아무리 빨라도 g(n)보다 빠를 수 없다"</strong>는 한계입니다.
...
<strong>"알고리즘의 성장률이 정확히 g(n)이다"</strong>라는 가장 강한 표현입니다.
