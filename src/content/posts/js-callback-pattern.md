...
지난 [이터러블과 제너레이터 — 반복을 프로토콜로 다루다](/posts/js-iterable-and-generator/) 글에서 이벤트 루프를 살펴봤습니다. 콜 스택이 비면 이벤트 루프가 큐에서 함수를 꺼내 실행한다고 했습니다. 그 "큐에 들어가는 함수"가 바로 **콜백(Callback)** 입니다.
