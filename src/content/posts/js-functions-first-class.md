...
지난 [원시 타입 vs 참조 타입 — 복사 버그의 근원](/posts/js-primitive-vs-reference/) 글에서 원시 타입과 객체 타입이 메모리에서 다르게 동작한다는 것을 살펴봤습니다. 그 차이의 핵심은 "값처럼 다루어지느냐"에 있었습니다. 이번 글은 그 연장선입니다. JavaScript에서 **함수도 값**입니다. 숫자나 문자열처럼 변수에 넣고, 전달하고, 반환할 수 있습니다.
