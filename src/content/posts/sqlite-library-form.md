...
[지난 글](/posts/mssql-ssrs-reporting/)에서 SQL Server의 보고서 플랫폼을 살펴봤다면, 이번 글부터는 방향을 완전히 바꿔 **SQLite**를 다룬다. SQLite는 세상에서 가장 많이 배포된 데이터베이스 엔진이지만, "설치"나 "서버 설정" 없이 쓸 수 있는 이유가 바로 **라이브러리 형태**에 있다.
