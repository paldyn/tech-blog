...
[지난 글](/posts/websec-security-mindset/)에서 보안 사고방식을 다뤘다. 이제 그 사고방식을 구체적인 공격 유형에 적용해보자. 이 글은 앞으로 다룰 공격들의 **항법 지도**(Navigation Map)다. 각 공격이 어떤 카테고리에 속하고, 핵심 방어 원칙이 무엇인지 한눈에 파악할 수 있다.
...
OWASP Top 10을 다루는 글들에서 각 공격을 상세히 살펴본다. 지금은 전체 지도를 머릿속에 그려두는 것으로 충분하다.
